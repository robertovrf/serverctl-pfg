...
docker build -t distributor:latest -f . < app/distributor.Dockerfile
docker build -t remote-dist:latest -f . < app/remotedist.Dockerfile
docker build -t server-ctl:latest -f . < server-ctl/Dockerfile
